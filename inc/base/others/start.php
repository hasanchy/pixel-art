...
global $wp_version;
if (\version_compare($wp_version, \PIXELART_MIN_WP, '>=')) {
    $load_core = \false;
    ...
    if ($load_core) {
        // Composer autoload
        $composer_autoload_path = \PIXELART_PATH . '/vendor/autoload.php';
        ...
        require_once \PIXELART_INC . 'base/others/fallback-rest-api.php';
    }

} else {
    // Min WP version not reached
    require_once \PIXELART_INC . 'base/others/fallback-wp-version.php';
}