...
const App = () => {
	...
	return (
		<div className="wrap">
			<h1 style={{ fontFamily: 'Trebuchet MS',fontWeight:500, fontSize: '35px', marginBottom: '15px' }}><span style={{ color: '#ffb61a' }}>Pixel</span><span style={{ color: '#674399' }}>Art</span></h1>
